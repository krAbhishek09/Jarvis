    ...
    while True:
        ...
        if "wake up" in query:
            ...
            while True:
                ...
                # Optional: Add a condition to break out of the outer loop
                if "exit" in query or "quit" in query:
                    ...
                    if temp:
                        ...
                        speak("Temperature information for Muzaffarpur not found.")
                    ...
                    if temp:
                        ...
                        speak("Weather information for Muzaffarpur not found.")
#aaaaa7#
def welcom():
    return "hello";
